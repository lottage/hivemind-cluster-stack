...
def index_obsidian_vault():
    """Indexes all notes from primary Obsidian vault into Qdrant."""
    print("\n--- [5/5] Indexing Primary Obsidian Vault Notes ---")
    ...
    for note_path in md_files:
        try:
            ...
            if any(k in lower_rel or k in lower_cnt for k in ["profile", "bio", "preferences", "personal", "user"]):
