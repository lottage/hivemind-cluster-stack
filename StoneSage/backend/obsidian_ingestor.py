...
Scans Austin's primary Obsidian vault and embeds personal notes, home info,
...
class ObsidianIngestor:
    def __init__(self, config: Dict[str, Any]):
        ...
        self.user_vault = obsidian_cfg.get("user_vault_path", r"C:\Users\johna\OneDrive\Documents\obsidian")
        self.backup_vault = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "vault_backup"))
        self.embedder_url = config.get("cluster", {}).get("embedder_url", "http://192.168.1.105:8003/v1").rstrip("/")
        self.qdrant_url = config.get("cluster", {}).get("qdrant_url", "http://192.168.1.112:6333").rstrip("/")
