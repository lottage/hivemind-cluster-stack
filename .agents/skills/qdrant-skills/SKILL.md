...
Directly derived from the official `skills.qdrant.tech` specification and tailored for the local dual-GPU cluster and vector brain running Qdrant 1.19.0 on LXC 117 (`192.168.1.112:6333`) with hardware-accelerated `bge-large-en-v1.5` embeddings on port 8003.

## 1. Local Vector Brain Topology
- **Host Endpoint**: `http://192.168.1.112:6333` (LXC 117)
