...
and conversation summaries into Qdrant (LXC 117 - 192.168.1.112:6333) using
hardware-accelerated BGE embeddings (192.168.1.105:8003).
...
EMBEDDER_URL = "http://192.168.1.105:8003/v1/embeddings"
QDRANT_URL = "http://192.168.1.112:6333"
WORKSPACE_DIR = r"c:\Users\johna\OneDrive\Documents\.ai"
USER_PROFILE_DIR = r"C:\Users\johna"
OBSIDIAN_VAULT_DIR = r"C:\Users\johna\OneDrive\Documents\obsidian"
...
SKILL_PATHS = [
    ...
    r"C:\Users\johna\.gemini\config\skills",
]

# Workspace Key Documents
WORKSPACE_DOCS = [
    r"c:\Users\johna\OneDrive\Documents\.ai\GEMINI.md",
    r"c:\Users\johna\OneDrive\Documents\.ai\server setup\NETWORK_DEVICE_REGISTRY.md",
    r"c:\Users\johna\OneDrive\Documents\.ai\server setup\COMPANION_MANIFESTO.md",
    r"c:\Users\johna\OneDrive\Documents\.ai\server setup\NEST_THERMOSTAT_GUIDE.md",
]
...
def index_system_invariants_and_memories():
    ...
    invariants = [
        ...
        ("host_ip_binding", "Host LAN IP Binding Reality: The Windows workstation is 192.168.1.132. StoneSage listens on 0.0.0.0:8080. Proxmox VIP is 192.168.1.245:8006."),
...
def index_recent_conversations():
    ...
    conv_logs = glob.glob(r"C:\Users\johna\.gemini\antigravity\brain\*\.system_generated\logs\transcript.jsonl")
    total_indexed = 0
