...
SSH_HOST = os.environ.get("SSH_CLUSTER_HOST", "austin@192.168.1.105")
COORDINATOR_HEALTH_URL = os.environ.get("COORDINATOR_HEALTH_URL", "http://192.168.1.105:8001/health")
